<?php
    ...
    $pembelian = query("SELECT * from tbl_pembelian inner join tbl_barang on tbl_pembelian.id_barang = tbl_barang.id_barang 
                        ...
                        where jenis_pembelian = 'Barang Lama' and tbl_pembelian.status = 0");
?>
                                    ...
                                    <?php $i = 1; foreach($pembelian as $row):?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <button class="btn btn-danger" onclick="return confirm('Tolak pembelian?')"><a class="text-decoration-none text-white" href="acc.php?tolak_pembelian_lama=<?=$row["id_pembelian"];?>"><i class="fas fa-times"></i> Tolak </a></button>
                                                </td>
                                            </tr>
                                        <?php $i++; endforeach;?>
                                    </tbody>
