...
$stok = query("SELECT * from tbl_keluar inner join tbl_barang on tbl_keluar.id_barang = tbl_barang.id_barang where nik = '$nik'");
$today = date("Y-m-d");
?>
        ...
        buttons: [
          {
            extend: 'pdfHtml5',
            text: 'Save as pdf',
            title: 'Laporan Stok Keluar <?=$nik;?> per: <?= $today;?>',
          },
          {
            extend: 'print',
            title: '<h6>Laporan Stok Keluar <?=$nik;?> per: <?= $today;?> </h6>',
